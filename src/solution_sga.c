...
{
	static const char filename[] = "data/cancer_data.txt";
	...
	static const char filename2[] = "data/cancer_label.txt";
...
void initialize(void)
{
	...
	/* open the input file        */
	if ((infile = fopen("data/gadata.txt", "r")) == NULL)
...
int main(void)
{
	...
	if ((galog = fopen("log/galog.txt", "w")) == NULL)
	{
